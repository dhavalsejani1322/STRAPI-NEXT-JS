...
export interface ApiHireDeveloperHireDeveloper
  extends Struct.CollectionTypeSchema {
  collectionName: 'hire_developers';
  info: {
    displayName: 'Hire Developer';
  ...
  attributes: {
    ...
    seo_keyword: Schema.Attribute.String & Schema.Attribute.Required;
    seo_metaImage: Schema.Attribute.Media<'images' | 'files'> &
      Schema.Attribute.Required;
    seo_title: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
...
export interface ApiTeamTeam extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Username: Schema.Attribute.Text & Schema.Attribute.Required;
  };
}
